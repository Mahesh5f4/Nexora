...
class RagPromptBuilder:
    ...
    ANALYSIS_SYSTEM_PROMPT = (
        ...
        "OUTPUT CONTRACT:\n"
        "- Format: natural prose, markdown where helpful (headers, bullets, bold).\n"
    ...
    CHAT_SYSTEM_PROMPT = (
        ...
        "- If the user asks you to remember something, explicitly acknowledge and confirm it. A background system automatically extracts and saves memories, so NEVER refuse a request to remember.\n\n"
        "OUTPUT CONTRACT:\n"
        "- Format: natural prose, markdown where helpful (headers, bullets, bold).\n"
        "- ALWAYS format commands, scripts, code snippets, and configuration files inside triple-backtick Markdown code blocks.\n"
        "- No rigid structure imposed on conversational answers.\n"
