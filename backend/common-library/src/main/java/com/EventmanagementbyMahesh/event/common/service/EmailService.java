...
public class EmailService {
    ...
    public void sendLoginOtpEmail(String to, String otp) {
        ...
        message.setTo(to);
        message.setSubject("Your Login OTP - ThinkAction AI");
        message.setText("Welcome to ThinkAction AI!\n\n" +
                "Your one-time password (OTP) for secure login is: " + otp + "\n" +
                "This OTP is valid for 5 minutes.\n\n" +
                "If you did not request this, please ignore this email.\n\n" +
                "Best regards,\nThe ThinkAction AI Team");
    ...
    public void sendForgotPasswordOtpEmail(String to, String otp) {
        ...
        message.setFrom(fromEmail);
        message.setTo(to);
        message.setSubject("Password Reset OTP - ThinkAction AI");
        message.setText("Hello from ThinkAction AI,\n\n" +
                "We received a request to reset the password for your account.\n" +
                "Your password reset one-time password (OTP) is: " + otp + "\n" +
