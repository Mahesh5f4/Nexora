...
- Name: analyze.spec.js >> Analyze Page >> page renders
- Location: tests\e2e\analyze.spec.js:15:3
...
Locator: locator('h1').filter({ hasText: 'Analyze Content' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1').filter({ hasText: 'Analyze Content' })
